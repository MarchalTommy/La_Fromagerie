...
| 9 | Hosted-checkout path via `createSumUpCheckout` | **LANDED as working WIP** (`ecda756`) | harden before calling it done: ~~FPW safety net~~ (closed 2026-07-08), single-shot verification, two-path duplicate analysis, hardcoded URL — see the LANDED block above |
