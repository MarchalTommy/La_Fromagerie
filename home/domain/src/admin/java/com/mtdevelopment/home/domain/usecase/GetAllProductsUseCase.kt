...
/**
 * Use case to retrieve all products for the administrator view, implementing a synchronization 
 ...
 *    - Fetches products from local [RoomHomeRepository].
 *    - Returns the list sorted alphabetically by name.
 */
    ...
    suspend operator fun invoke(
        ...
        if (shouldRefresh) {
            firebaseHomeRepository.getAllProducts(onSuccess = { productsList ->
                ...
                // Sorting: Alphabetically by name (Admin view shows all products regardless of availability)
